...
#  Adjunta este script al nodo raíz de la escena (Node2D)
# ============================================================

# ------ Referencias a nodos (se asignan en _ready) ----------
@onready var lbl_result  : Label  = $UI/"Lbl resultado"    # ← pon tu nombre exacto
@onready var lbl_saldo   : Label  = $UI/LblSaldo
@onready var lbl_apuesta : Label  = $UI/LaLblApuestabel3   # ← el tuyo
...
# Física simple
const RADIO_BORDE  : float = 185.0  # era 210.0 — justo dentro del aro
const RADIO_CENTRO : float = 65.0   # era 70.0
...
func _ready() -> void:
	...
	rueda.position = Vector2(432, 300)  # centro horizontal, un poco arriba de centro
...
func _calcular_resultado() -> void:
	# Ángulo relativo de la bola respecto a la rueda
